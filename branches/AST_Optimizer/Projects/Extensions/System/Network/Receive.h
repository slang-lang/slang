...
#ifndef ObjectiveScript_Extensions_System_Network_Receive_h
#define ObjectiveScript_Extensions_System_Network_Receive_h
...
class Receive : public ExtensionMethod
{
public:
	Receive()
	: ExtensionMethod(0, "receive", Designtime::IntegerObject::TYPENAME)
	{
