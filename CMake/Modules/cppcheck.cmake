...
if (NOT ${CPPCHECK_PATH} STREQUAL "")
    get_filename_component(CPPCHECK_HINT_FILENAME ${CPPCHECK_PATH} NAME)
    get_filename_component(CPPCHECK_HINT_PATH ${CPPCHECK_PATH} DIRECTORY)
endif ()
