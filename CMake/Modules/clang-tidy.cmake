...
if (NOT ${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
    if (NOT ${LINTER_PATH} STREQUAL "")
        get_filename_component(CLANG_TIDY_HINT_FILENAME ${LINTER_PATH} NAME)
        get_filename_component(CLANG_TIDY_HINT_PATH ${LINTER_PATH} DIRECTORY)
    endif ()
