...
private object SortByOccupacity implements IShuttleSortAlgorithm {
    public bool compare(Shuttle left const, Shuttle right const) const {
        ...
        return left.stateID == ShuttleState.OCCUPIED && left.stateID > right.stateID;
    }
}

public object PreferDoubleCycleShuttles extends SortingStep implements IDispatchStep {
