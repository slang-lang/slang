...
#ifndef Core_Runtime_BuildInTypes_Int64Type_h
#define Core_Runtime_BuildInTypes_Int64Type_h
...
public:
	explicit Int64Type( int64_t value = 0 );
	explicit Int64Type( const AtomicValue& value );
	explicit Int64Type( const std::string& name, const AtomicValue& value );
	explicit Int64Type( const Object& object );
